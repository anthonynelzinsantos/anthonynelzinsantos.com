...
Fort de seize ans d’expérience dans le journalisme technologique et
l’enseignement universitaire, j’ai développé mon expertise dans des contextes
variés. De l’édition d’une collection de manuels informatiques à la création
d’un master de journalisme au Burkina Faso, j’ai appris à concevoir des méthodes
d’apprentissage qui s’adaptent aux besoins et aux contraintes de publics très
différents.

Mon approche se concentre sur la création de systèmes pédagogiques robustes. Je
développe des parcours d’apprentissage, des guides méthodologiques, et des
dispositifs pédagogiques qui permettent de maintenir la qualité dans la durée.
